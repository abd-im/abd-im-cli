...
### II. Clear Scope
Name canonical documents for their scope. Keep them concise and decision-oriented; keep cross-project research elsewhere.
...
Treat examples as illustrative unless explicitly declared exhaustive. Model capability families with general rules and explicit authorization.
...
Deliver every active task and its acceptance criteria. When requirements or integration details are uncertain, inspect relevant local projects as implementation evidence before deciding; the active project specification remains authoritative.
