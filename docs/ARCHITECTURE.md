...
| [`internal/capability`](../internal/capability) | capability manifest；action handler 与 daemon-owned action source 按 IM 领域组织（当前为 [`group`](../internal/capability/group) 和 [`message`](../internal/capability/message)）。 |
